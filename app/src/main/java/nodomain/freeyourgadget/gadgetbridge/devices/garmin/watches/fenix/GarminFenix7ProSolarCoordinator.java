...
public class GarminFenix7ProSolarCoordinator extends GarminWatchCoordinator {
    @Override
    ...
    protected Pattern getSupportedDeviceName() {
        ...
        return Pattern.compile("^fenix 7 Pro Solar$");
    }

    @Override
    public int getDeviceNameResource() {
        return R.string.devicetype_garmin_fenix_7_pro_solar;
    }
