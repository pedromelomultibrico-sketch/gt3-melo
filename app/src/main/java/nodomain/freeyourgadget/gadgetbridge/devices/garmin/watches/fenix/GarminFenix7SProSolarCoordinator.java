...
public class GarminFenix7SProSolarCoordinator extends GarminWatchCoordinator {
    @Override
    ...
    protected Pattern getSupportedDeviceName() {
        ...
        return Pattern.compile("^fenix 7S Pro Solar$");
    }

    @Override
    public int getDeviceNameResource() {
        return R.string.devicetype_garmin_fenix_7s_pro_solar;
    }
